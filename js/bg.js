const UNSPLASH_API_KEY = "SdrFuUoSLEkCkRdymbYpbAg9qpvtDiASrNXdDWURV2o";
...
function loadBackground() {
  ...
  if (savedImage === null) {
    ...
    if (today > parsedImage.expiresOn) {
      ...
      body.style.backgroundImage = `linear-gradient(rgba(0, 0, 0, 0.5),rgba(0,0,0,0.4)), url(${parsedImage.url})`;
